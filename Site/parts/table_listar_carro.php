...
<table class="table is-striped is-fullwidth">
    <thead>
        <tr>
            ...
            <th class='has-text-centered'>Ano</th>
            <th class='has-text-centered'>Pessoa</th>
    ...
    <tbody>
        ...
        foreach ($listaCarros as $carro) {
            echo "<tr>";
            echo "<td class='has-text-centered'>" . $carro["id"] . "</td>";
            echo "<td class='has-text-centered'>" . $carro["nome"] . "</td>";
            echo "<td class='has-text-centered'>" . $carro["marca"] . "</td>";
            echo "<td class='has-text-centered'>" . $carro["ano"] . "</td>";
            echo "<td class='has-text-centered'>" . Pessoa::getOne($carro["idPessoa"])[0]["nome"] . "</td>";
            echo "<td class='has-text-centered'><a href='editarCarro.php?id=" . $carro["id"] . "'>
            <span class='icon'>
            ...
            echo "<td class='has-text-centered'><a href='deletarCarro.php?id=" . $carro["id"] . "'>
            <span class='icon'>
